...
const DeleteBlogPage: React.FC = () => {
  ...
  const handleDelete = async () => {
    try {
      ...
      router.push('/'); // Redirect to the Blog Search Page after deletion
    } catch (error) {
  ...
  const handleCancel = () => {
    router.push('/'); // Redirect to the Blog Search Page if deletion is cancelled
  };
  ...
  return (
    <div className="container mx-auto w-fit text-center bg-slate-300 p-4 rounded-md mt-8">
